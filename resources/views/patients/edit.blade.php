            ...
            <form method="POST" action="{{ route('patients.update', $patient) }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="address" rows="2"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm">{{ old('address', $patient->address) }}</textarea>
                </div>
