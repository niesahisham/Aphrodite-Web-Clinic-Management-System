        ...
        <aside class="w-64 bg-white shadow-md flex flex-col justify-between py-6 px-4 fixed h-full">
            ...
            <div>
                ...
                <nav class="space-y-1">
                    ...
                    {{-- Electronic Medical Records - admin, doctor, nurse only --}}
                    @if(Auth::user()->role !== 'receptionist')
                    <a href="{{ route('medical-records.index') }}"
                        class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium
                        {{ request()->routeIs('medical-records.*') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-100' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <a href="{{ route('queue.index') }}"
                        ...
                        {{ request()->routeIs('queue.*') ? 'bg-blue-50 text-blue-600' : 'text-gray-500 hover:bg-gray-100' }}">
