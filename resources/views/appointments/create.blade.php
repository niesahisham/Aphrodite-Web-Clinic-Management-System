...
@section('content')
        ...
        <form action="{{ route('appointments.store') }}" method="POST" class="space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="appointment_type" required
                        ...
                        <option value="Health Check" {{ old('appointment_type') === 'Health Check' ? 'selected' : '' }}>Health Check</option>
                    </select>
                </div>
            ...
            <div>
                ...
                <select name="status" required
                    ...
                    <option value="waiting" {{ old('status') === 'waiting' ? 'selected' : '' }}>Waiting - add to queue now</option>
                </select>
            </div>
            ...
            <div>
                ...
                <textarea name="notes" rows="3"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm">{{ old('notes') }}</textarea>
            </div>
    ...
    <script>
        ...
        function checkAvailability() {
            ...
            fetch(`{{ route('appointments.availability') }}?doctor_id=${doctorInput.value}&scheduled_at=${dateInput.value}`)
